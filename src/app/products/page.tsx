...
const Products = () => {
  ...
  return (
    <div className="min-h-screen bg-background p-4 sm:p-8 grid lg:grid-cols-[260px_1fr] gap-6 relative">

      {/* ===== Sidebar ===== */}
      <aside className={`bg-card shadow-md p-4 z-40 transition-transform duration-300 lg:translate-x-0 lg:rounded-2xl lg:sticky lg:top-20 lg:h-fit
      ...
      <main className="flex-1 flex flex-col gap-6 w-full">
        ...
        {/* Sticky Top Bar */}
        <div className="hidden lg:flex items-center justify-between mb-4 sticky top-0 z-20 bg-background p-4 shadow-sm rounded-xl">
          <input
            type="text"
            placeholder="Search products..."
            value={search}
          ...
          />
          <Button onClick={() => router.push('/products/create')} className="ml-4 px-5 py-2">
            Add Product
          </Button>
        </div>
